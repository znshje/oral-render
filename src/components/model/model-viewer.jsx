...
function ModelViewer({children, index}, ref) {
    ...
    const label = useAppSelector(state => state.base.render.labels[index]);
    ...
    return (
        <div
                            ...
                            <Popover.Portal>
                                <Popover.Content
                                    ...
                                    <div style={{display: 'flex', flexDirection: 'column', gap: 16}}>
                                        <h3 style={{marginBottom: 10}}>设置</h3>
                                        <div>
            ...
            {label && label.length > 0 && (
                <div
                    style={{
                        fontSize: renderConfig.font.size,
                        fontWeight: renderConfig.font.bold ? 'bold' : 'normal',
                        position: renderConfig.font.absolute ? 'absolute' : 'relative',
                        bottom: 0,
